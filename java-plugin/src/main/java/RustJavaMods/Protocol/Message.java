...
public final class Message extends Table {
  ...
  public static boolean MessageBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RJMS"); }
  ...
  public static int createMessage(FlatBufferBuilder builder,
    ...
    Message.addMsgType(builder, msgType);
  ...
  public static void finishMessageBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RJMS"); }
  public static void finishSizePrefixedMessageBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RJMS"); }
